...
export const businessService = {
  async manageBusiness(business: ManageRequest): Promise<Business> {
    return apiService.authPostWithStore<Business>('/api/v1/business', business);
  },
  ...
  async updateBusiness(business: Business): Promise<Business> {
    return apiService.authPatchWithStore<Business>(`/api/v1/business/${business.id}`, business);
  },
